        ...
        <div className="about-page-container">
            ...
            <div className="about-content">
                ...
                <p className="description">
                    ...
                    At Murugan Pattasu Kadai, you can order Diwali crackers, crackers gift boxes, fancy crackers, and crackers for special occasions online at a reasonable price with the safest door/area delivery.<br />
                ...
                <h5 className="about-info">
                    <a href="https://www.instagram.com/muruganpattasukadai/" target="_blank" rel="noopener noreferrer" className="instagram-link">
